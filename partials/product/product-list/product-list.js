...
class ProductList {
  ...
  static initHandlers() {
    ...
    const obShopaholicPagination = new ShopaholicPagination(obListHelper);
    obShopaholicPagination.init();

    const obShopaholicSorting = new ShopaholicSorting(obListHelper);
